      ...
      attacks: [
        {
          spawners: [
            ...
            },
            {
              ...
              immediate: true,
              spin: 0.1,
              behaviors: [ SpawnerBehavior.pulse ],
              parameters: {
                pulse_delay: 0,
                pulse_frequency: 1,
                pulse_min_speed: 0,
            ...
            {
              sources: [
                {x: 800, y: 100, heading: 0},
                {x: 800, y: 100, heading: Math.PI},
              ],
              x: 800, y: 300, heading: 0, random_spread: 0,
              delay: 1,
              sync: 11200,
              lifespan: 800,
              aimed: false,
              ...
              debug: false,
              spin: 1.3,
              behaviors: [ SpawnerBehavior.move ],
              parameters: {
                dx: -0.5,
                dy: 0,
                move_countdown: 0
